...
Este proyecto es un demo educativo. Pokémon y todas las marcas relacionadas son propiedad de Nintendo, Game Freak y Creatures Inc.

## 🤝 Contribuir

Este es un proyecto de demostración. Para mejoras:
1. Implementar base de datos (PostgreSQL/MongoDB)
2. Agregar pasarela de pagos (Webpay, Mercado Pago)
3. Mejorar panel de administración
4. Tests E2E con Cypress

## 📞 Contacto

- Email: contacto@pokestore.cl
